...
// -----------------------------------------------------------------------------
// TRNG top with 128-bit UART output.
//
// A completed 128-bit raw entropy block is kept internal, then transmitted as
// 16 UART bytes. This avoids exposing raw_entropy[127:0] as 128 FPGA pins while
// still allowing the full block to be collected on a PC.
// -----------------------------------------------------------------------------

module rram_ro_trng_uart_top #(
